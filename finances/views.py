...
def add_expense_attachment(request, expense_id):
...
def remove_expense_attachment(request, attachment_id):
...
def replenish_petty_cash(request, fund_id):
...
def close_petty_cash_fund(request, fund_id):
...
def reopen_petty_cash_fund(request, fund_id):
...
def view_petty_cash_fund(request, fund_id):
...
def view_petty_cash_transactions(request, fund_id):
...
def get_department_expense_breakdown(request, department_id):
...
def create_expense_budget(request):
...
def update_expense_budget(request, budget_id):
...
def delete_expense_budget(request, budget_id):
...
def view_expense_budget(request, budget_id):
...
def list_expense_budgets(request):
...
def get_budget_utilization_report(request):
