...
from api.models import RateLimitRule, RateLimitAttempt, RateLimitBlock, ApiClient, SystemKey, APICallback
...
class GatewayControlMiddleware:
    ...
    def __call__(self, request):
        ...
        callback = APICallback.objects.filter(path=request.path, is_active=True).first()
        if callback:
