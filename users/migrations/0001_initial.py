    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='schools.branch', verbose_name='Branch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('synced', models.BooleanField(default=False, help_text='Indicates whether this record has been synchronized with the replica system.', verbose_name='Synced')),
                ('description', models.CharField(blank=True, max_length=100, verbose_name='Description')),
                ('name', models.CharField(choices=[('student', 'Student'), ('guardian', 'Guardian'), ('teacher', 'Teacher'), ('clerk', 'Clerk'), ('admin', 'Admin')], max_length=50, unique=True, verbose_name='Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_receive_reports', models.BooleanField(default=True, help_text='Authorized to receive student notifications and communications.', verbose_name='Can receive reports')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is active')),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_guardians', to=settings.AUTH_USER_MODEL, verbose_name='Student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='schools.classroom', verbose_name='Classroom')),
